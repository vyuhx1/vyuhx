...
export default class MyVisitDetails extends LightningElement {
    @api value; // VisitResponseDTO — injected by the Lightning Type renderer
    @track _currentIdx = 0;
    ...
    get hasCancelled()    { return (this._response.cancelledCount ?? 0) > 0; }
